const s = { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: 1.5, stroke: "currentColor" } as const;

export function IconServer(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg {...s} {...props} className={`w-4 h-4 ${props.className ?? ""}`}>
...
export function IconSignal(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg {...s} {...props} className={`w-4 h-4 ${props.className ?? ""}`}>
...
export function IconArrowPath(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg {...s} {...props} className={`w-4 h-4 ${props.className ?? ""}`}>
